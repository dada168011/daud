...
function OpenAmmuActionsMenu()
  ...
  local elements = {
	{label = 'Parcheggia il veicolo', value = 'vehicle_list'},
   ...
   if PlayerData.job ~= nil and PlayerData.job.grade_name == 'second' or PlayerData.job ~= nil and PlayerData.job.grade_name == 'boss'  then 
	table.insert(elements, {label = 'Prendi', value = 'get_stock'})
    table.insert(elements, {label = 'Prendi Arma', value = 'get_weapon'})
	table.insert(elements, {label = 'Deposita Arma', value = 'put_weapon'})
  end
...
function OpenAmmuHarvestMenu()
  ...
  if Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.grade_name ~= 'stagiaire' and PlayerData.job.name == 'ammunation' then
    local elements = {
	  ...
	  {label = 'Acciaio', value = 'acier_recolt'}
    }
...
function OpenAmmuCraftMenu()
  if Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.grade_name ~= 'recrue' and PlayerData.job.grade_name ~= 'employé' and PlayerData.job.name == 'ammunation' then
    ...
    local elements = {
	  {label = 'Munizioni', value = 'munition'},
	  {label = 'Manganello - $ ' .. Config.Price.weapon_nightstick, value = 'weapon_nightstick'},
	  {label = 'SNS pistol - $ ' .. Config.Price.weapon_snspistol, value = 'weapon_snspistol'},
      {label = 'Pistola - $ ' .. Config.Price.weapon_pistol, value = 'weapon_pistol'},
	  {label = 'Pistola vintage - $ ' .. Config.Price.weapon_vintagepistol, value = 'weapon_vintagepistol'},
	  {label = 'Pistola da Combattimento - $ ' .. Config.Price.weapon_combatpistol, value = 'weapon_combatpistol'},
	  {label = 'Pistola Cal.50 - $ ' .. Config.Price.weapon_pistol50, value = 'weapon_pistol50'},
	  {label = 'Pistola Pesante - $ ' .. Config.Price.weapon_heavypistol, value = 'weapon_heavypistol'},
	  ...
	  {label = 'Mitragliatrice leggera - $ ' .. Config.Price.weapon_minismg, value = 'weapon_minismg'},
	  {label = 'AP Pistol - $ ' .. Config.Price.weapon_appistol, value = 'weapon_appistol'},
	  {label = 'Micro SMG - $ ' .. Config.Price.weapon_microsmg, value = 'weapon_microsmg'},
	  {label = 'Pistola di precisione - $ ' .. Config.Price.weapon_marksmanpistol, value = 'weapon_marksmanpistol'},
	  {label = 'Moschetto - $ ' .. Config.Price.weapon_musket, value = 'weapon_musket'},
	  {label = 'Taser - $ ' .. Config.Price.weapon_stungun, value = 'weapon_stungun'},
	  {label = 'Carabina d\'assalto - $ ' .. Config.Price.weapon_carbinerifle, value = 'weapon_carbinerifle'},
	  {label = 'Mitragliatrice d\'assalto - $ ' .. Config.Price.weapon_assaultsmg, value = 'weapon_assaultsmg'},
	  {label = 'ADP de combat - $ ' .. Config.Price.weapon_combatpdw, value = 'weapon_combatpdw'},
	  {label = 'Mitraglietta - $ ' .. Config.Price.weapon_smg, value = 'weapon_smg'},
	  {label = 'Fucile d\'assalto - $ ' .. Config.Price.weapon_assaultrifle, value = 'weapon_assaultrifle'},
	  {label = 'Mitragliatrice da combattimento - $ ' .. Config.Price.weapon_combatmg, value = 'weapon_combatmg'},
	  {label = 'Fucile con pompa d\'assalto - $ ' .. Config.Price.weapon_assaultshotgun, value = 'weapon_assaultshotgun'},
	  {label = 'Fucile a pompa - $ ' .. Config.Price.weapon_sawnoffshotgun, value = 'weapon_sawnoffshotgun'},
	  {label = 'Cecchino - $ ' .. Config.Price.weapon_sniperrifle, value = 'weapon_sniperrifle'},
	  {label = 'Fucile di precisione - $ ' .. Config.Price.weapon_marksmanrifle, value = 'weapon_marksmanrifle'},
	  {label = 'Fucile di precisione pesante - $ ' .. Config.Price.weapon_heavysniper, value = 'weapon_heavysniper'},
    }
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value == 'weapon_pistol' then
		  ...
		  exports.utils:getUtils().showProgressBarTimer(15000, "Assemblaggio in corso ..", "Pistola assemblata !")
		...
		if data.current.value == 'weapon_combatpistol' then
		  ...
		  exports.utils:getUtils().showProgressBarTimer(15000, "Assemblaggio in corso ..", "Pistola da Combattimento assemblata !")
		  TaskStartScenarioInPlace(playerPed, "PROP_HUMAN_BUM_BIN", 15000, true)
		  Citizen.Wait(15000)
		  ClearPedTasksImmediately(playerPed)
        end
		...
		if data.current.value == 'weapon_snspistol' then
		  ...
		  exports.utils:getUtils().showProgressBarTimer(15000, "Assemblaggio in corso ..", "SNS pistol assemblata !")
		  TaskStartScenarioInPlace(playerPed, "PROP_HUMAN_BUM_BIN", 15000, true)
		  Citizen.Wait(15000)
		  ClearPedTasksImmediately(playerPed)
        end
		...
		if data.current.value == 'weapon_heavypistol' then
		  ...
		  exports.utils:getUtils().showProgressBarTimer(15000, "Assemblaggio in corso ..", "Pistola Pesante assemblata !")
		  TaskStartScenarioInPlace(playerPed, "PROP_HUMAN_BUM_BIN", 15000, true)
		  Citizen.Wait(15000)
		  ClearPedTasksImmediately(playerPed)
        end
		...
		if data.current.value == 'weapon_marksmanpistol' then
		  ...
		  exports.utils:getUtils().showProgressBarTimer(15000, "Assemblaggio in corso ..", "Fucile di precisione assemblato !")
		  TaskStartScenarioInPlace(playerPed, "PROP_HUMAN_BUM_BIN", 15000, true)
		  Citizen.Wait(15000)
		  ClearPedTasksImmediately(playerPed)
        end
		...
		if data.current.value == 'weapon_vintagepistol' then
		  ...
		  exports.utils:getUtils().showProgressBarTimer(15000, "Assemblaggio in corso ..", "Pistola vintage assemblata !")
		  TaskStartScenarioInPlace(playerPed, "PROP_HUMAN_BUM_BIN", 15000, true)
		  Citizen.Wait(15000)
		  ClearPedTasksImmediately(playerPed)
        end
		...
		if data.current.value == 'weapon_musket' then
		  ...
		  exports.utils:getUtils().showProgressBarTimer(15000, "Assemblaggio in corso ..", "Moschetto assemblato !")
		  TaskStartScenarioInPlace(playerPed, "PROP_HUMAN_BUM_BIN", 15000, true)
		  Citizen.Wait(15000)
		  ClearPedTasksImmediately(playerPed)
        end
		...
		if data.current.value == 'weapon_stungun' then
		  ...
		  exports.utils:getUtils().showProgressBarTimer(15000, "Assemblaggio in corso ..", "Teaser assemblato !")
		  TaskStartScenarioInPlace(playerPed, "PROP_HUMAN_BUM_BIN", 15000, true)
		  Citizen.Wait(15000)
		  ClearPedTasksImmediately(playerPed)
        end
		...
		if data.current.value == 'weapon_pistol50' then
		  ...
		  exports.utils:getUtils().showProgressBarTimer(15000, "Assemblaggio in corso ..", "Pistola Cal.50 assemblata !")
		  TaskStartScenarioInPlace(playerPed, "PROP_HUMAN_BUM_BIN", 15000, true)
		  Citizen.Wait(15000)
		  ClearPedTasksImmediately(playerPed)
        end
		...
		if data.current.value == 'weapon_revolver' then
		  ...
		  exports.utils:getUtils().showProgressBarTimer(15000, "Assemblaggio in corso ..", "Revolver assemblata !")
		  TaskStartScenarioInPlace(playerPed, "PROP_HUMAN_BUM_BIN", 15000, true)
		  Citizen.Wait(15000)
		  ClearPedTasksImmediately(playerPed)
        end
		...
		if data.current.value == 'weapon_carbinerifle' then
		  ...
		  exports.utils:getUtils().showProgressBarTimer(15000, "Assemblaggio in corso ..", "Carabina d'assalto assemblata !")
		  TaskStartScenarioInPlace(playerPed, "PROP_HUMAN_BUM_BIN", 15000, true)
		  Citizen.Wait(15000)
		  ClearPedTasksImmediately(playerPed)
        end
		...
		if data.current.value == 'weapon_assaultsmg' then
		  ...
		  exports.utils:getUtils().showProgressBarTimer(15000, "Assemblaggio in corso ..", "Mitragliatrice d\'assalto assemblata !")
		  TaskStartScenarioInPlace(playerPed, "PROP_HUMAN_BUM_BIN", 15000, true)
		  Citizen.Wait(15000)
		  ClearPedTasksImmediately(playerPed)
        end
		...
		if data.current.value == 'weapon_combatpdw' then
		  ...
		  exports.utils:getUtils().showProgressBarTimer(15000, "Assemblaggio in corso ..", "ADP de combat assemblé !")
		  TaskStartScenarioInPlace(playerPed, "PROP_HUMAN_BUM_BIN", 15000, true)
		  Citizen.Wait(15000)
		  ClearPedTasksImmediately(playerPed)
        end
		...
		if data.current.value == 'weapon_assaultshotgun' then
		  ...
		  exports.utils:getUtils().showProgressBarTimer(15000, "Assemblaggio in corso ..", "Fucile con pompa d\'assalto !")
		  TaskStartScenarioInPlace(playerPed, "PROP_HUMAN_BUM_BIN", 15000, true)
		  Citizen.Wait(15000)
		  ClearPedTasksImmediately(playerPed)
        end
		...
		if data.current.value == 'weapon_sniperrifle' then
		  ...
		  exports.utils:getUtils().showProgressBarTimer(15000, "Assemblaggio in corso ..", "Cecchino assemblato !")
		  TaskStartScenarioInPlace(playerPed, "PROP_HUMAN_BUM_BIN", 15000, true)
		  Citizen.Wait(15000)
		  ClearPedTasksImmediately(playerPed)
        end
		...
		if data.current.value == 'weapon_heavysniper' then
		  ...
		  exports.utils:getUtils().showProgressBarTimer(15000, "Assemblaggio in corso ..", "Fucile di precisione pesante assemblato !")
		  TaskStartScenarioInPlace(playerPed, "PROP_HUMAN_BUM_BIN", 15000, true)
		  Citizen.Wait(15000)
		  ClearPedTasksImmediately(playerPed)
        end
		...
		if data.current.value == 'weapon_doubleaction' then
		  ...
		  exports.utils:getUtils().showProgressBarTimer(15000, "Assemblaggio in corso ..", "Revolver double action  assemblata !")
		  TaskStartScenarioInPlace(playerPed, "PROP_HUMAN_BUM_BIN", 15000, true)
		  Citizen.Wait(15000)
		  ClearPedTasksImmediately(playerPed)
        end
		...
		if data.current.value == 'weapon_appistol' then
		  ...
		  exports.utils:getUtils().showProgressBarTimer(15000, "Assemblaggio in corso ..", "AP Pistol assemblata !")
		  TaskStartScenarioInPlace(playerPed, "PROP_HUMAN_BUM_BIN", 15000, true)
		  Citizen.Wait(15000)
		  ClearPedTasksImmediately(playerPed)
        end
		...
		if data.current.value == 'weapon_microsmg' then
		  ...
		  exports.utils:getUtils().showProgressBarTimer(15000, "Assemblaggio in corso ..", "Micro SMG assemblata !")
		  TaskStartScenarioInPlace(playerPed, "PROP_HUMAN_BUM_BIN", 15000, true)
		  Citizen.Wait(15000)
		  ClearPedTasksImmediately(playerPed)
        end
		...
		if data.current.value == 'weapon_smg' then
		  ...
		  exports.utils:getUtils().showProgressBarTimer(15000, "Assemblaggio in corso ..", "Mitraglietta assemblata !")
		  TaskStartScenarioInPlace(playerPed, "PROP_HUMAN_BUM_BIN", 15000, true)
		  Citizen.Wait(15000)
		  ClearPedTasksImmediately(playerPed)
        end
		...
		if data.current.value == 'weapon_sawnoffshotgun' then
		  ...
		  exports.utils:getUtils().showProgressBarTimer(15000, "Assemblaggio in corso ..", "Fucile a pompa assemblato !")
		  TaskStartScenarioInPlace(playerPed, "PROP_HUMAN_BUM_BIN", 15000, true)
		  Citizen.Wait(15000)
		  ClearPedTasksImmediately(playerPed)
        end
		...
		if data.current.value == 'weapon_assaultrifle' then
		  ...
		  exports.utils:getUtils().showProgressBarTimer(15000, "Assemblaggio in corso ..", "Fucile d\'assalto assemblato !")
		  TaskStartScenarioInPlace(playerPed, "PROP_HUMAN_BUM_BIN", 15000, true)
		  Citizen.Wait(15000)
		  ClearPedTasksImmediately(playerPed)
        end
		...
		if data.current.value == 'weapon_combatmg' then
		  ...
		  exports.utils:getUtils().showProgressBarTimer(15000, "Assemblaggio in corso ..", "Mitragliatrice da combattimento assemblata !")
		  TaskStartScenarioInPlace(playerPed, "PROP_HUMAN_BUM_BIN", 15000, true)
		  Citizen.Wait(15000)
		  ClearPedTasksImmediately(playerPed)
        end
		...
		if data.current.value == 'weapon_minismg' then
		  ...
		  exports.utils:getUtils().showProgressBarTimer(15000, "Assemblaggio in corso ..", "Mitragliatrice leggera assemblata !")
		  TaskStartScenarioInPlace(playerPed, "PROP_HUMAN_BUM_BIN", 15000, true)
		  Citizen.Wait(15000)
		  ClearPedTasksImmediately(playerPed)
        end
	    ...
	    if data.current.value == 'weapon_nightstick' then
		  ...
		  exports.utils:getUtils().showProgressBarTimer(15000, "Assemblaggio in corso ..", "Manganello assemblato !")
		  TaskStartScenarioInPlace(playerPed, "PROP_HUMAN_BUM_BIN", 15000, true)
		  Citizen.Wait(15000)
		  ClearPedTasksImmediately(playerPed)
        end
	  ...
	  ESX.UI.Menu.Open(
		'default', GetCurrentResourceName(), 'mobile_ammu_actions',
		{
		  ...
		  elements = {
			...
			{label = 'Port D\'Armi',    value = 'license'},
		  }
		},
		function(data, menu)
		  ...
		  if data.current.value == 'license' then
			...
			ESX.UI.Menu.Open(
			  'default', GetCurrentResourceName(), 'citizen_interaction',
			  {
				...
				align    = 'top-left',
				elements = {
				  {label = 'Porto d\'Armi',       value = 'tier1'}
				},
			  },
...
-- Create Blips
Citizen.CreateThread(function()
  local blip = AddBlipForCoord(16.61, -1109.34, 42.37)
...
function refreshBlips()
  ...
  if PlayerData.job ~= nil and PlayerData.job.name == 'ammunation' then
    ...
    SetBlipAsShortRange(blip, true)
    BeginTextCommandSetBlipName("STRING")
    AddTextComponentString("Ammu-Nation - Produzione di armi")
    EndTextCommandSetBlipName(blip)
  end
  if PlayerData.job ~= nil and PlayerData.job.name == 'ammunation' then
    ...
    SetBlipAsShortRange(blip, true)
    BeginTextCommandSetBlipName("STRING")
    AddTextComponentString("Ammu-Nation - Materiali")
    EndTextCommandSetBlipName(blip)
  end
  if PlayerData.job ~= nil and PlayerData.job.name == 'ammunation' then
    ...
    SetBlipAsShortRange(blip, true)
    BeginTextCommandSetBlipName("STRING")
    AddTextComponentString("Ammu-Nation - Polvere da Sparo")
    EndTextCommandSetBlipName(blip)
  end
  if PlayerData.job ~= nil and PlayerData.job.name == 'ammunation' then
    ...
    SetBlipAsShortRange(blip, true)
    BeginTextCommandSetBlipName("STRING")
    AddTextComponentString("Ammu-Nation - Presa ")
    EndTextCommandSetBlipName(blip)
  end
  if PlayerData.job ~= nil and PlayerData.job.name == 'ammunation' then
    ...
    SetBlipAsShortRange(blip, true)
    BeginTextCommandSetBlipName("STRING")
    AddTextComponentString("Ammu-Nation - Vendita")
    EndTextCommandSetBlipName(blip)
  end
end
-- Display markers
